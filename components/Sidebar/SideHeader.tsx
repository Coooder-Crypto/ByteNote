    ...
    <div className="flex h-16 items-center justify-between px-4">
      ...
      <div className="flex items-center gap-2">
        <Link href="/notes" title="进入笔记">
          <button className="rounded-full border border-slate-200 bg-white p-1.5 text-slate-400 shadow hover:text-primary md:hidden">
        ...
        <button
          ...
          className="hidden rounded-full border border-slate-200 bg-white p-1.5 text-slate-400 shadow-md transition hover:text-primary md:inline"
