...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      {...props}
    >
      <SelectPrimitive.ScrollUpButton className="bg-popover flex cursor-default items-center justify-center py-1">
      ...
      <SelectPrimitive.ScrollDownButton className="bg-popover flex cursor-default items-center justify-center py-1">
